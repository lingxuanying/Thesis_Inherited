# -*- coding: utf-8 -*-
"""DATA_GRU+非時序+Similarity_as_weight.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1NnQDUZUYVeTZlfYLTJlZpg_gCzzy963a
"""
...
# training_file = '/content/drive/My Drive/IDH_Thesis/Training Data/label_data_'+criteria+'/train_file.pickle'
...
training_file = sys.argv[8]+'train_file.pickle'
validation_file = sys.argv[8]+'valid_file.pickle'
testing_file = sys.argv[8]+'test_file.pickle'
...
# u_training_file = '/content/drive/My Drive/IDH_Thesis/Training Data/new_similarity/similarity_lstm_'+criteria+'/train_file.pickle'
# u_validation_file = '/content/drive/My Drive/IDH_Thesis/Training Data/new_similarity/similarity_lstm_'+criteria+'/valid_file.pickle'
# u_testing_file = '/content/drive/My Drive/IDH_Thesis/Training Data/new_similarity/similarity_lstm_'+criteria+'/test_file.pickle'
u_training_file = sys.argv[9]+'train_file.pickle'
u_validation_file = sys.argv[9]+'valid_file.pickle'
u_testing_file = sys.argv[9]+'test_file.pickle'
